...
public class AdminPlantsView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_plants_view);
        ...
        plants = new Plants(AdminPlantsView.this, "PlantDB.sqlite",null,1);
        plants.queryData();


        // Plants
        listView = findViewById(R.id.ListViewPlantsID);
        getDetailslist = new ArrayList<>();
        ...
        // add button
        AddButton = findViewById(R.id.AddPlantsButtonID);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                showDetails(AdminPlantsView.this, position);
            }
        });
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                new AlertDialog.Builder(AdminPlantsView.this)
                        ...
                        .setItems(items, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (which == 0){
                                    try {
                                        int plantId = getIdFromCursor(position);
                                        updateDialog(AdminPlantsView.this, plantId);
                                    }catch (Exception e){
    ...
    public void openAdminAddActivity(){
        Intent intent = new Intent (AdminPlantsView.this,AdminAdd.class);
        startActivity(intent);
    }

    public void getNewestPlant(){
        // get data from sqlite (table Plants)
        Cursor cursor = AdminPlantsView.plants.getData();
    ...
    int getIdFromCursor(int position){
        ...
        Cursor plantCursor = plants.getData();
        plantCursor.moveToPosition(position);
        return plantCursor.getInt(0);
    }
    ...
    private void updateDialog(Activity activity, final int id){
        ...
        updateHerbs.setEnabled(false);

        image_input.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivityCompat.requestPermissions(AdminPlantsView.this,
        ...
        updatePlants.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
                    plants.updateData(
                    ...
                    Toast.makeText(getApplicationContext(), "Plant ID " + id +" updated", Toast.LENGTH_SHORT).show();
                    getNewestPlant();
                }
                catch (Exception e){
    ...
    private void deleteDialog(final int id){
        AlertDialog.Builder deleteDialog = new AlertDialog.Builder(AdminPlantsView.this);
        ...
        deleteDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    plants.deleteData(id);
                    getNewestPlant();
                    Toast.makeText(getApplicationContext(), "Plant ID " + id + " deleted", Toast.LENGTH_SHORT).show();
                }catch (Exception e){
